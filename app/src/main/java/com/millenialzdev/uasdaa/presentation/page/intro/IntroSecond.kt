 ...
 * Use the [IntroSecond.newInstance] factory method to
...
class IntroSecond : Fragment() {
    ...
    override fun onCreateView(
        ...
        val buttonIntroNext = view.findViewById<Button>(R.id.buttonIntroNext)
        val viewPager = activity?.findViewById<ViewPager2>(R.id.introPager)
    ...
    companion object {
         ...
         * @return A new instance of fragment IntroSecond.
         */
